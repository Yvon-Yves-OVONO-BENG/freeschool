...
class InsolvableService
{
     ...
     * @return Pagination
     */
    public function printStudentInsolvable(Classroom $classroom, School $school, SchoolYear $schoolYear): Pagination
    {
        $fontSize = 10;
        $cellHeaderHeight1 = 4;
        $cellHeaderHeight = 6;
        ...
        $medicalBookletFeesRest = 0;

        $cleanSchoolFeesAdvance = 0;
        $cleanSchoolFeesRest = 0;
        ...
        // Entête de la liste
        $pdf = $this->generalService->getHeaderStudentListInsolvable($pdf, $school, $classroom);
