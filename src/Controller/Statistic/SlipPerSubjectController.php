...
#[Route("/statistic")]
class SlipPerSubjectController extends AbstractController
{
    ...
    #[Route("/slipPerSubject", name:"statistic_slipPerSubject")]
    public function slipPerSubject(Request $request): Response
    {
        ...
        return $this->render('statistic/slipPerSubject.html.twig', [
            'subjects' => $subjects,
            'terms' => $terms,
            'sequences' => $sequences,
