...
class ReferenceRegisterController extends AbstractController
{
    ...
    #[Route("/referenceRegister/{pv<[0-1]>}", name:"register_and_list_referenceRegister")]
    public function referenceRegister(Request $request, int $pv = 0): Response
    {
      ...
      $classrooms = $this->classroomService->splitClassrooms($classrooms);
        ...
        return $this->render('register_and_list/referenceRegister.html.twig', [
