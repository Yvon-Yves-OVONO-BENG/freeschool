...
class PrintTopFiveStudentsByClassroomService 
{
     ...
     * @return Pagination
     */
    public function printTopFiveStudentsByClassroomService(array $topFiveStudents, SchoolYear $schoolYear, School $school, SubSystem $subSystem, Term $term, Classroom $classroom): Pagination
    {
