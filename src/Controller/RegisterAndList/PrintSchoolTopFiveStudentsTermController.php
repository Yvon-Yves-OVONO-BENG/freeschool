...
class PrintSchoolTopFiveStudentsTermController extends AbstractController
{
    ...
    #[Route("/printSchoolTopFiveStudentsTerm", name:"print_school_top_five_students_per_term")]
    public function printSchoolTopFiveStudentsPerTerm(Request $request): Response
    {
