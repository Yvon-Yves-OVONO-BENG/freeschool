...
class PrintTopFiveStudentsByLevelService 
{
     ...
     * @return Pagination
     */
    public function printTopFiveStudentsByLevelService(array $topFiveStudents, SchoolYear $schoolYear, School $school, SubSystem $subSystem, Term $term, Level $level): Pagination
    {
        ...
        else
        {
            ...
            // Entête de la fiche
            $pdf->SetFont('Times', 'B', $fontSize+4);
            $pdf->Cell(150, 7, utf8_decode("SCHOOL TOP FIVE STUDENTS IN LEVEL "), 0, 1, 'R');
            switch ($level->getLevel()) 
            {
                case 1:
