...
class PrintSchoolTopFiveStudentsSubjectTermService 
{
     ...
     * @return Pagination
     */
    public function printSchoolTopFiveStudentsSubjectServiceTerm(array $topFiveStudents, SchoolYear $schoolYear, School $school, SubSystem $subSystem, Subject $subject, Term $term): Pagination
    {
