...
class PrintTopFiveStudentsByCycleAndSubjectService 
{
     ...
     * @return Pagination
     */
    public function printTopFiveStudentsByCycleAndSubjectService(array $topFiveStudents, SchoolYear $schoolYear, School $school, SubSystem $subSystem, Cycle $cycle, Subject $subject, Term $term): Pagination
    {
        ...
        else
        {
            ...
            $pdf->Cell(190, 7, utf8_decode("SUBJECT : ".$subject->getSubject()), 0, 1, 'C');
