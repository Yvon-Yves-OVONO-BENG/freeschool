...
class BestResultsPerTermController extends AbstractController
{
    ...
    #[Route("/best-result-per-term", name:"best_result_per_term")]
    public function bestStudentsPerClass(Request $request): Response
    {
        ...
        return $this->render('register_and_list/bestResultsPerTerm.html.twig', [
            'terms' => $terms,
            'subjects' => $subjects,
